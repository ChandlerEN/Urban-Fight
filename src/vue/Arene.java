...
public class Arene extends JFrame implements Global {
	...
	/**
	 * Traite la touche utilisée dans la zone de saisie
	 * @param arg0
	 */
	...
	/**
	 * Traite la touche utilisée dans la zone de jeu :
	...
	private void contentPane_keyPressed(KeyEvent arg0) {
		...
		switch (arg0.getKeyCode()) {
			...
			case KeyEvent.VK_C : valeur = SPECIAL; break;	// ajout de l'attaque special
		}
		// controle si une touche correcte a été utilisée
		if (valeur != -1) {
			// envoi de l'action
...
//		setBounds(100, 100, L_ARENE + L_CHAT + 3*MARGE, H_ARENE + MARGE);
		setBounds(100, 100, L_ARENE + L_CHAT + 3*MARGE, H_ARENE + MARGE*8);
		...
		jspChat.setBounds(800, 0, 200, 600);
