...
public class Attaque extends Thread implements Global {
	 ...
	 * @param jeuServeur
	 */
	public Attaque(Joueur attaquant, JeuServeur jeuServeur, ArrayList<Mur> lesMurs, Hashtable<Connection, Joueur> lesJoueurs, Integer Attack) {
	...
	public void run() {
		...
		laboule.label.getjLabel().setIcon(new ImageIcon(EXPLOSION));
		jeuServeur.envoi(laboule.getLabel());
